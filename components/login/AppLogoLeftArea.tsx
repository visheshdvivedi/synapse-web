...
const AppLogoLeftArea = () => {
    return (
        <div className="flex flex-col justify-center items-center gap-5 w-[50%] h-screen bg-linear-to-br from-blue-900 to-blue-950">
            ...
            <Label className='text-4xl text-white font-bold'>Synapse</Label>
            <Label className='text-xl text-primary-foreground/50 max-w-[50%] text-center'>Real-time learning, reimagined. Connect, collaborate, and grow together.</Label>
        </div>
    )
}
